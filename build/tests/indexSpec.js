...
var thumbInfo = fs_1.default.statSync("./thumb/".concat(fs_1.default.readdirSync('./thumb/')[0]));
var thumbSize = thumbInfo.size;
var imgInfo = fs_1.default.statSync("./images/".concat(fs_1.default.readdirSync('./images/')[0]));
...
describe("II- Test for my application's functionality", function () {
    it('1. tests the availability of the thumbnail image in the thumb folder', function () {
        expect(index_1.default.get('/process', function (req) { return "./thumb/".concat(req.query.filename, "_thumb.jpg"); })).toBeTruthy();
    });
